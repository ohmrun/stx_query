...
typedef QAgg 						= stx.query.QAgg;
typedef QBinop 					= stx.query.QBinop;
typedef QDiveDef<T> 		= stx.query.QDive.QDiveDef<T>;
typedef QDive<T> 	  		= stx.query.QDive<T>;
...
typedef QGather<T> 			= stx.query.QGather<T>;
typedef QGatherSum<T>  	= stx.query.QGather.QGatherSum<T>;
